...
INSERT INTO wrestlers (name, finishing_move, height_feet, height_inches, weight_lbs) VALUES
('Cody Rhodes', 'Cross Rhodes', 6, 2, 220),
('Gunther', 'Powerbomb', 6, 6, 284),
('Nia Jax', 'Leg Drop', 6, 0, 271),
('Liv Morgan', 'Oblivion', 5, 5, 119),
('Jey Uso', 'Uso Splash', 6, 2, 236),
('LA Knight', 'BFT (Blunt Force Trauma)', 6, 2, 236),
('Tama Tonga', 'Gun Stun', 6, 0, 215),
('Tonga Loa', 'Apeshit', 6, 1, 264),
('Finn Balor', 'Coup de Grace', 5, 11, 190),
('JD McDonagh', 'Devil Inside', 5, 10, 190),
('Bianca Belair', 'KOD (Kiss of Death)', 5, 7, 165),
('Jade Cargill', 'Jaded', 5, 10, 160),
('Roman Reigns', 'Spear', 6, 3, 265),
('Rey Mysterio', '619', 5, 6, 174),
('Kevin Owens', 'Stunner', 6, 0, 265),
('Sami Zayn', 'Helluva Kick', 6, 2, 212),
('Becky Lynch', 'Manhandle Slam', 5, 7, 135),
('AJ Styles', 'Phenomenal Forearm', 5, 11, 218),
('Randy Orton', 'RKO', 6, 5, 290),
('Charlotte Flair', 'Figure Eight', 5, 10, 143),
('Asuka', 'Asuka Lock', 5, 3, 128),
('Drew McIntyre', 'Claymore Kick', 6, 5, 265),
('Sheamus', 'Brogue Kick', 6, 3, 267),
('Damian Priest', 'Reckoning', 6, 5, 249),
('Dominik Mysterio', 'Frog Splash', 6, 1, 190),
('Shinsuke Nakamura', 'Kinshasa', 6, 2, 229),
('Iyo Sky', 'Moonsault', 5, 1, 115),
('Bayley', 'Rose Plant', 5, 6, 119),
('Dakota Kai', 'Kai-ropractor', 5, 6, 121),
('Carmella', 'Code of Silence', 5, 5, 110),
('Alexa Bliss', 'Twisted Bliss', 5, 1, 102),
('Omos', 'Chokeslam', 7, 3, 410),
('Braun Strowman', 'Running Powerslam', 6, 8, 385),
('Karrion Kross', 'Kross Jacket', 6, 4, 265),
('Bronson Reed', 'Tsunami', 5, 11, 330),
('Uncle Howdy', 'Sister Abigail', 6, 3, 285),
('Jimmy Uso', 'Uso Splash', 6, 3, 251),
('Jacob Fatu', 'Moonsault', 6, 2, 262),
('Solo Sikoa', 'Samoan Spike', 6, 2, 252),
('Tiffany Stratton', 'Prettiest Moonsault Ever', 5, 7, 132),
('Chad Gable', 'Ankle Lock', 5, 8, 202),
('The Rock', 'Rock Bottom', 6, 5, 260),
('CM Punk', 'GTS (Go To Sleep)', 6, 2, 218),
('Andrade', 'Hammerlock DDT', 5, 9, 210),
('Carmelo Hayes', 'Nothing But Net', 5, 10, 200),
('Montez Ford', 'From the Heavens', 6, 1, 227),
('Angelo Dawkins', 'Anointment', 6, 5, 260),
('Austin Theory', 'ATL (A-Town Down)', 6, 1, 220),
('Grayson Waller', 'Rolling Thunder Stunner', 6, 0, 205),
('Kofi Kingston', 'Trouble in Paradise', 6, 0, 212),
('Xavier Woods', 'Limit Break', 5, 11, 205),
('Bron Breakker', 'Spear', 6, 0, 230),
('Rhea Ripley', 'Riptide', 5, 8, 137),
('R-Truth', 'Lie Detector', 6, 2, 220),
('The Miz', 'Skull-Crushing Finale', 6, 2, 221),
('Seth Rollins', 'Curb Stomp', 6, 2, 225);
